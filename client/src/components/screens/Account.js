...
const Account = ({ history }) => {
  ...
  useEffect(() => {
    ...
    // setCity(userInfo["deliveryInformation"]["city"]);
  }, [history, userInfo]);

  const accountModificationHandler = (e) => {
    e.preventDefault();
    console.log("1");
  };

  const deliveryModificationHandler = (e) => {
    e.preventDefault();
    console.log("2");
  };
  ...
  return (
    <>
      <div className="flex w-screen justify-around">
        <form
          onSubmit={accountModificationHandler}
          action=""
          className="form-auth flex-grow h-c m-8 gap-7"
        >
        ...
        <form
          onSubmit={deliveryModificationHandler}
          action=""
          className="form-auth flex-grow m-8 gap-7"
        >
